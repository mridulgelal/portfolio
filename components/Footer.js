export const Footer = () => {
  return (
    <footer className="flex justify-evenly bg-cyan-100 absolute w-full -ml-10 right-0 h-20 ">
      <div className=" p-10 ml-10 flex ">
        <a class="mr-9  text-gray-800">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
      ...
      <div>
        <div class="text-center text-gray-700  text-sm pt-10 w-full ">
          © 2022 Copyright:
